...
- Comments
    - Exploits found that were missed in the initial audit:
        ...
        - LP: The LP box does not check that it is itself the box at INPUTS(0), but the Swap contract assumes it is. Further explanation with on-chain analysis can be found [here](https://ergoforum.org/t/use-dexygold-lp-hack-postmortem/5362).
